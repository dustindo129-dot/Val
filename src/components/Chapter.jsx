      ...
      <div className="chapter-container">
        ...
        <div className="chapter-bottom-actions">
          ...
          <div className="share-buttons">
            <a href="#" onClick={(e) => { e.preventDefault(); handleShare('facebook'); }} className="share-btn facebook" title="Share on Facebook">
              <FontAwesomeIcon icon={faFacebookF} />
            </a>
            <a href="#" onClick={(e) => { e.preventDefault(); handleShare('twitter'); }} className="share-btn twitter" title="Share on Twitter">
              <FontAwesomeIcon icon={faTwitter} />
            </a>
            <a href="#" onClick={(e) => { e.preventDefault(); handleShare('pinterest'); }} className="share-btn pinterest" title="Share on Pinterest">
              <FontAwesomeIcon icon={faPinterestP} />
            </a>
            <a href="#" onClick={(e) => { e.preventDefault(); handleShare('telegram'); }} className="share-btn telegram" title="Share on Telegram">
            ...
            {chapterList.length === 0 && (
                <>
                  ...
                  <li className="chapter-item current">
                    <Link to={`/novel/${novelId}/chapter/${chapterId}`}>Chapter {chapter.chapterNumber || 3}</Link>
                  </li>
                </>
            )}
          </ul>
