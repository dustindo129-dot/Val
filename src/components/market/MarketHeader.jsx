      ...
      <div className="market-overview">
        ...
        <div className="overview-section">
          ...
          <ul>
            ...
            <li>Nếu thanh đóng góp vượt quá 100% .</li>
          </ul>
        </div>
        ...
        <div className="overview-section">
          ...
          <ul>
            ...
            <li>Xin nhắc lại là chỉ đề xuất được những bộ đã có sẵn, việc này khuyến khích dịch giả chạy các bộ truyện mới và mở công khai những chương đầu để thu hút người đọc.</li>
          </ul>
        </div>
